define([], function () {
  return {
    ...
    PublishToSharePointLabel: "Publish",
    ...
    PublishSuccessMessage: "Published to SharePoint site:",
    ...
    PublishPanelTitle: "Publish skill to SharePoint",
    PublishPanelDescription:
      "Choose a SharePoint site that has the Agent Assets feature enabled.",
    PublishPanelSearchPlaceholder: "Search enabled SharePoint sites\u2026",
    PublishPanelLoadingLabel: "Loading SharePoint sites\u2026",
    PublishPanelNoSites:
      "No SharePoint sites with Agent Assets were found for your account.",
    PublishPanelNoResults: "No enabled sites match your search.",
    PublishPanelError:
      "Could not load SharePoint publish targets. Try refreshing the panel.",
    PublishHereLabel: "Publish here",
    BrowseIntoLabel: "Open",
    PublishRootLabel: "Tenant",
    PublishSiteUrlLabel: "Site URL",
    PublishTargetRefreshLabel: "Refresh sites",
    PublishPanelCurrentLocationLabel: "Current location",
